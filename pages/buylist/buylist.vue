<template>
	<view class="app">
		<view class="app_bg">
			<!-- 顶部 -->
			<topnav :title="$t('list.gmlist')" urlline="market"></topnav>
			...
			<scroll-view class="cs_list" scroll-y="true" @scrolltolower="dddd()">
				<view class="list_info" v-for="(item,i) in mmlist">
					<view class="card_content">
						...
						<!-- 状态 -->
						<view class="list_type">{{$t('list.buy')}}</view>
					</view>
					<view class="info_right">
						<view class="info_data">
							<view class="data_name">{{$t('list.tradeprice')}}：</view>
							<view class="data_num">{{item.paymoney}} LOO</view>
						</view>
						<view class="info_data">
							<view class="data_name">{{$t('list.selllist')}}：</view>
							<view class="data_num">{{item.address}}</view>
						</view>
						<view class="info_data">
							<view class="data_name">{{$t('list.cjtime')}}：</view>
